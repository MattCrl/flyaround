...
class FlightController extends Controller
{
     ...
     * @Method("GET")
     */
    public function showAction(Flight $flight, FlightInfo $flightInfo, PlaneModel $plane)
    {
        // Process to calculate the distance between Departure and Arrival
